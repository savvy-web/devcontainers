...
| [`claude-code`](../../docs/features/claude-code.md) | Installs the Claude Code CLI agent globally using the official native installer. | `ghcr.io/savvy-web/claude-code` |
